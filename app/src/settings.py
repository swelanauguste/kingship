...
#allows to save apps in an apps folder
...
SECRET_KEY = 'django-insecure-w2pzzrm+xny*fw)14dw9@w=4klmfq@!!fo=-b6lon3yq19*706'
...
ACCOUNT_ADAPTER = "apps.users.new_user_adapater.UsersAccountAdapter"
